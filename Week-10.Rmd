...
The primary challenge of cross-validation is the need for excessive
computational resources, especially in methods such as k-fold CV. Since
the algorithm has to be rerun from scratch for k times, it requires k
times more computation to evaluate.
